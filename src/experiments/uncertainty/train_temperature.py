...
def train_temperature(
    ...
    **kwargs,
    ...
    logs_path = "{}/logs/uncertainity/train_temperature_{}_{}_{}.log".format(
    ...
    for epoch in range(1, n_epochs+1):
        ...
        classifier_temp = ModelWithTemperature(classifier.module).to(device)
        ...
        #=====Results==========
        train_preds = F.softmax(train_preds, dim=1)
        test_preds = F.softmax(test_preds, dim=1)
