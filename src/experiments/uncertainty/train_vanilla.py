...
def train_vanilla(
    ...
    **kwargs,
    ...
    logs_path = "{}/logs/uncertainity/train_vanilla_{}_{}_{}.log".format(
    ...
    for epoch in range(1, n_epochs+1):
        ...
        #train_ece = ece(train_preds.numpy(), F.one_hot(train_labels, n_classes).numpy())
        #test_ece = ece(test_preds.numpy(), F.one_hot(test_labels, n_classes).numpy())
